...
public class JdbcPagingItemReaderJobConfiguration {
    ...
    @Bean
    public Step jdbcPagingItemReaderStep(JobRepository jobRepository, PlatformTransactionManager transactionManager,
                                         JdbcPagingItemReader<Pay> jdbcPagingItemReader, ItemWriter<Pay> jdbcPagingItemWriter) {
    ...
    @Bean
    public JdbcPagingItemReader<Pay> jdbcPagingItemReader(DataSource dataSource, PagingQueryProvider createQueryProvider) {
