...
public class ProcessorNullJobConfiguration {
    ...
    public Step step(JobRepository jobRepository, PlatformTransactionManager transactionManager,
                     JpaPagingItemReader<Teacher> processorNullBatchReader, ItemProcessor<Teacher, Teacher> processorNullBatchProcessor) {
        return new StepBuilder(BEAN_PREFIX+"step", jobRepository)
                ...
                .processor(processorNullBatchProcessor)
                .writer(writer())
                .build();
    }

    @Bean
    public JpaPagingItemReader<Teacher> processorNullBatchReader(EntityManagerFactory entityManagerFactory) {
    ...
    @Bean
    public ItemProcessor<Teacher, Teacher> processorNullBatchReaderProcessor() {
        return teacher -> {
    ...
    private ItemWriter<Teacher> writer() {
        return chunk -> {
            for (Teacher teacher : chunk.getItems()) {
